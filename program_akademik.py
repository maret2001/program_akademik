...
# status angkatan
if int(data_semester) == int(1) or int(data_semester) == int (2):
    print(f"5. Status {data_nama} adalah mahasiswa angkatan 2022")
elif int(data_semester) == int (3) or int(data_semester) == int (4):
    print(f"5. Status {data_nama} adalah mahasiswa angkatan 2021")
elif int(data_semester) == int (5) or int(data_semester) == int (6):
    print(f"5. Status {data_nama} adalah mahasiswa angkatan 2020")
elif int(data_semester) == int (7) or int(data_semester) == int (8):
    print(f"5. Status {data_nama} adalah mahasiswa angkatan 2019") 
elif int(data_semester) == int (9) or int(data_semester) == int (10):
    print(f"5. Status {data_nama} adalah mahasiswa angkatan 2018")
elif int(data_semester) == int (11) or int(data_semester) == int (12):
    print(f"5. Status {data_nama} adalah mahasiswa angkatan 2017")
elif int(data_semester) == int (13) or int(data_semester) == int (14):
